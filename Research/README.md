...
- [Synchronizing Two Signals (Frequency-Independent)](#synchronizing-two-signals-frequency-independent)
  - [1. Pure Phase Shifting Method](#1-pure-phase-shifting-method)
  - [2. Frequency-Domain Phase Synchronization](#2-frequency-domain-phase-synchronization)
  - [3. Constant Phase Offset Correction](#3-constant-phase-offset-correction)
